...
def args_parser():
    ...
    parser.add_argument('--sel_clients', type=int, default=10, help="number of selected users: K")
    parser.add_argument('--frac', type=float, default=0.1, help="the fraction of clients: C")
    parser.add_argument('--local_ep', type=int, default=1, help="the number of local epochs: E")
    parser.add_argument('--local_bs', type=int, default=100, help="local batch size: B")
    parser.add_argument('--bs', type=int, default=128, help="test batch size")
    parser.add_argument('--lambda_loss', type=float, default=0.01, help="lambda loss")
    ...
    parser.add_argument('--sel_scheme', type=str, default='full', help="name of dataset")
